...
I will write a short description of the dataset,noting the size and structure of the data, 
describing key variables, and giving illustrative examples of observations:
...
Let's also investigate the busiest hour of the day for orders, on average. 
